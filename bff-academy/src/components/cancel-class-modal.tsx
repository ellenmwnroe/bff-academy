...
export function CancelClassModal({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full max-w-md flex-col gap-5 rounded-4xl border-4 border-cosmos bg-white p-6 shadow-[8px_8px_0_0_var(--color-cosmos)]">
        {/* Cabeçalho */}
        <header className="flex items-start gap-3">
          <div className="grid size-12 shrink-0 place-items-center rounded-xl border-[3px] border-cosmos bg-crimson shadow-[2px_2px_0_0_var(--color-cosmos)]">
            <CalendarX className="size-6 text-white" strokeWidth={2.5} aria-hidden="true" />
          </div>

          <div className="flex min-w-0 flex-1 flex-col">
            <h2 id="cancel-modal-title" className="text-2xl font-black text-cosmos">
              Cancelar Aula
            </h2>
            {lessonTitle && (
              <p className="truncate text-sm font-bold text-cosmos/60">
                {lessonTitle}
        ...
        {earnsTicket ? (
          <div className="flex gap-2.5 rounded-xl border-2 border-cosmos bg-varden p-3">
            <Ticket
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm font-medium text-cosmos/70">
          ...
          <div className="flex gap-2.5 rounded-lg border-2 border-crimson/20 bg-gochujang/10 p-3">
            <AlertTriangle
              className="size-5 shrink-0 text-crimson"
              strokeWidth={2.5}
              aria-hidden="true"
            />
            <div className="flex flex-col gap-1">
              <p className="text-sm font-black text-crimson">
